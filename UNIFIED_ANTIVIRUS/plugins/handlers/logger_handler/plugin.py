...
class LoggerHandlerPlugin(BasePlugin, HandlerPluginInterface):
    ...
    def __init__(self, config_path: str = None):
        ...
        self.logger.info(
            f"[LOGGER_HANDLER] Plugin inicializado con {len(self.loggers)} loggers"
        )
    ...
    def _add_to_buffer(
        self, logger_name: str, level: str, message: str, extra_data: Dict[str, Any]
    ):
            ...
            for entry in self.log_buffer:
                try:
                    ...
                    if logger_name in self.loggers:
                        ...
                        log_level = getattr(
                            logging, entry["level"].upper(), logging.INFO
                        )
